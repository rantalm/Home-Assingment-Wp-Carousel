...
function colmibil_enqueue_files() {
  ...
  if (strstr($_SERVER['SERVER_NAME'], 'colmobil-test.local') ) {
    ...
    wp_enqueue_script('main-js', get_theme_file_uri('/bundled-assets/scripts.65d7f8473342335b3814.js'), NULL, '1.0', true);
    wp_enqueue_style('main-styles', get_theme_file_uri('/bundled-assets/styles.65d7f8473342335b3814.css'));
  }
}
