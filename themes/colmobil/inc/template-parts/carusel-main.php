...
<?php if (!empty($models)) : ?>
  ...
  <section>
      ...
      <div class="swiper-wrapper">
        ...
        <?php foreach ($models as $model) : ?>
          <div class="swiper-slide">
            ...
            <div class="main-carusel__container">
              <h2 class="color-brown"><?= $model['title']; ?></h2>
              <p class="description"><?= $model['excerpt'] ?></p>
              <a href="#">קרא עוד</a> <span class="color-brown">></span>
            </div>
          </div>
    ...
    <div class="carusel-play" id="carusel-play">
